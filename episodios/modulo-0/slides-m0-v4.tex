...
\newcommand{\nota}[1]{\bigskip\hfill{\color{gray}\footnotesize#1}}
\newcommand{\site}[2]{%
...
\begin{center}
  ...
  \Large Tipografia para a era digital 
  \hfill\uncover<2->{\small\textcolor{red!80!black}{1978!!}}
\end{center}
...
\uncover<1->{\nota{Foto: Computer History Museum}}
\end{frame}
